...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:16px">
  ...
  <a href="/pages/customers.php" style="text-decoration:none">
  ...
  <a href="/pages/cards.php" style="text-decoration:none">
    <div style="background:#fff;padding:24px;border-radius:8px;
                box-shadow:0 2px 6px rgba(0,0,0,.08);text-align:center">
      <div style="font-size:30px">💳</div>
  ...
  <a href="/pages/invoices.php" style="text-decoration:none">
    <div style="background:#fff;padding:24px;border-radius:8px;
                box-shadow:0 2px 6px rgba(0,0,0,.08);text-align:center">
      <div style="font-size:30px">🧾</div>
  ...
  <a href="/pages/audit.php" style="text-decoration:none">
    <div style="background:#fff;padding:24px;border-radius:8px;
                box-shadow:0 2px 6px rgba(0,0,0,.08);text-align:center">
      <div style="font-size:30px">🔍</div>
